...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.locale = {
            ...
            separator: ' - ',
            applyLabel: i18n != undefined ? i18n.apply : 'Apply',
            cancelLabel: i18n != undefined ? i18n.cancel : 'Cancel',
            weekLabel: 'W',
            customRangeLabel: i18n != undefined ? i18n.custom_range : 'Custom Range',
        ...
        if (typeof options.addClassCustom === 'function')
            this.addClassCustom = options.addClassCustom;
        ...
        renderCalendar: function(side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    //Add Class Custom - by Quan
                    classes.push( this.addClassCustom( calendar[row][col]) );
