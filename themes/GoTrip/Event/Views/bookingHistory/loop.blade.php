        ...
        <div class="dropdown js-dropdown js-actions-1-active">
            ...
            <div class="toggle-element -dropdown-2 js-click-dropdown js-actions-{{ $key + 1 }}-toggle">
                <div class="text-14 fw-500 js-dropdown-list">
                    ...
                    <div><a href="{{route('user.booking.ticket',['code'=>$booking->code])}}" class="d-block js-dropdown-link btn-info-booking open-new-window" onclick="window.open(this.href); return false;">{{ __("Print Ticket") }}</a></div>
