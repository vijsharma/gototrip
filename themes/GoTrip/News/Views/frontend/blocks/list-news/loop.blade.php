...
<a href="{{$row->getDetailUrl()}}" class="blogCard -type-1 d-block ">
    ...
    <div class="mt-15">
        <h4 class="text-dark-1 text-18 sm:text-16 fw-500">{!! clean($translation->title) !!}</h4>
        <div class="d-none text-light-1 text-15 sm:text-14 lh-14 mt-5">{{ display_date($row->updated_at)}}</div>
    </div>
</a>
@endif
