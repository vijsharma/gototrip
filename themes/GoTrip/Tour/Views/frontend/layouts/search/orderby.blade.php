<div class="col-auto">
    <div class="item d-flex align-items-center">
        ...
        <div class="dropdown">
        <span class="button -blue-1 h-40 px-20 rounded-100 bg-blue-1-05 text-14 text-blue-1"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="col-auto d-none lg:d-block">
    <button data-x-click="filterPopup" class="button -blue-1 h-40 px-20 rounded-100 bg-blue-1-05 text-14 text-blue-1">
        <i class="icon-up-down text-14 mr-10"></i>
        {{__('Filter')}}
    </button>
</div>
