                    ...
                    <div class="itinerary__item">
                        <div class="d-flex">
                            <div class="accordion__icon size-40 flex-center bg-blue-2 text-blue-1 rounded-full">
                                <div class="text-16 fw-500">{{$key+1}}</div>
                            </div>
                            <div class="ml-20">
                                <div class="lh-15 fw-500">{{$item['title']}}</div>
                                <div class="text-16 lh-15 text-light-1 mt-5">{{$item['desc']}}</div>
                             ...
                             <div class="itinerary__content">
                                <div class="pt-15 pb-15">
                                   <!--<img src="{{ !empty($item['image_id']) ? get_file_url($item['image_id'],"full") : "" }}" alt="{{$item['desc']}}" class="rounded-4 mt-15">-->
                                     <div class="lh-17 mt-5">{!! clean($item['content']) !!}</div>
                                    </div>
                                </div>
