<section class="layout-pt-md layout-pb-md">
    <div data-anim-wrap class="container">
        ...
        <div class="relative overflow-hidden pt-40 sm:pt-20 js-section-slider" data-gap="30" data-scrollbar data-slider-cols="xl-5 lg-4 md-3 sm-3 base-1" data-nav-prev="js-tour-prev" data-pagination="js-tour-pag" data-nav-next="js-tour-next">
                    ...
                    @foreach($rows as $row)
                        ...
                        <div class="swiper-slide">
                            <a href="{{ route('tour.search',['cat_id[]' => $row->id]) }}" class="tourTypeCard -type-1 d-block rounded-4 bg-blue-1-05 rounded-4">
                                <div class="tourTypeCard__content text-center sm:pt-30 pt-60 pb-24 px-30">
                                    <i class="{{$row->cat_icon}} text-60 sm:text-40 text-blue-1"></i>
                                    <h4 class="text-dark-1 text-18 fw-500 mt-50 md:mt-30 sm:mt-10">{{$translation->name}}</h4>
                                    @if($row->tour_count)
