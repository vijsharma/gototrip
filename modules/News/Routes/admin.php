...
Route::get('/getForSelect2','NewsController@getForSelect2')->name('news.admin.getForSelect2');
...
Route::get('/tag/getForSelect2','TagController@getForSelect2')->name('news.admin.tag.getForSelect2');
