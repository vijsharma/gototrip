<div class="panel">
    <div class="panel-title ptitle"><strong>{{__("Pricing")}}</strong></div>
    <div class="panel-body pbody">
        @if(is_default_lang())
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="panel-body-title">{{__("Deposite booking")}}</h3>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="deposit_enable" value="1" @if(!empty($meta->deposit_enable)) checked @endif > {{__('Yes, please enable it')}}</label>
                        </div>
                    </div>
                    <div class="form-group" data-condition="deposit_enable:is(1)">
                        <label >{{__('Deposit Amount')}}</label>
                        <div class="form-controls">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        <input type="number" name="deposit_amount" class="form-control" step="0.1" value="{{!empty($meta->deposit_amount)?$meta->deposit_amount:""}}" >
                                        <select name="deposit_type"  class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option @if(!empty($meta->deposit_type) && $meta->deposit_type == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group" data-condition="deposit_enable:is(1)">
                        ...
                        <div class="form-controls">
                            <div class="row">
                                <div class="col-md-12">
                                    <select name="deposit_fomular" class="form-control" >
                                        <option value="default" {{($meta->deposit_fomular ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                        <option value="deposit_and_fee" {{ ($meta->deposit_fomular ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
